...
public class Chord {
	...
	public static void main (String[] args) {
		...
		if (args.length == 1) {
			InetSocketAddress me = Helper.createSocketAddress(local_ip+":"+args[0]);
			m_node = new Node (me, dn,me);
		...
		// join, contact is another node
			...
			m_node = new Node (Helper.createSocketAddress(local_ip+":"+args[0]), dn,m_contact);
		}
